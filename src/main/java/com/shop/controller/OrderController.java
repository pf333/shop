...
public class OrderController {
    ...
    public @ResponseBody/*java object를 변환하여 HttpResonse의 body에 반환*/
    ResponseEntity order(@RequestBody/*HttpRequest의 body를 java object로 변환*/ @Valid OrderDto orderDto
        ...
        if (bindingResult.hasErrors()) {
            ...
            return new ResponseEntity<String>(sb.toString(), HttpStatus.BAD_REQUEST); //HttpRequest에 대한 응답 데이터 반환
        }
